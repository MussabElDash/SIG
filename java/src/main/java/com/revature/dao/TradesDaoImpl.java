...
public class TradesDaoImpl implements TradesDao {
	...
	/**
	 * long insertTrades(Trade trades) - Inserts a new instance of Trade to be
	 * persisted in the DB. Returns a LONG of the generated ID for the new Trade
	 * upon success. Returns NULL if the insertion fails.
	 */
	...
	/**
	 * Trade selectTradesByTradeId(Long tradeId) - Fetches a persisted instance of a
	 * Trade from the DB by its associated id that is passed in. Returns the
	 * specific trade instance upon successful fetch. Returns NULL upon failure.
	 */
	...
	/**
	 * List<Trade> selectAllTrades() - Fetches all persisted instances of Trade from
	 * the DB. Returns a list of all persisted Trade upon success. Returns NULL upon
	 * failure.
	 */
	@Override
	...
	/**
	 * boolean deleteTradesByTradeId(Trade delTrade) - Removes a persisted Trade
	 * from the database matching the given Trade instance passed in. Returns TRUE
	 * upon successful removal, returns FALSE upon failure.
	 */
	@Override
	...
	/**
	 * boolean updateTrades(Trade upTrade) - Updates a persisted Trade in the DB to
	 * the given instance of Trade. Returns TRUE if the update succeeds. Returns
	...
	/**
	 * List<Trade> selectTradesByRequestorAccount(Account a) - Fetches a list of all
	 * persisted Trades in the DB belonging to the provided Account instance
	 * belonging to the Trade Requestor. Returns a List of all Trades belonging to
	 * the account upon successful fetch. Returns NULL if the fetch fails.
	 */
	@Override
	...
	/**
	 * List<Trade> selectTradesByReceiverAccount(Account a) - Retrieves all
	 * persisted Trades from the DB belonging to the given Reciever Account
	 * instance. Returns a List of all Trades belonging to the account upon
	 * successful fetch. Returns NULL upon failure.
	 */
	@Override
