...
public class TestTradesDAOImpl {
	...
	/*
	 * What constraints does trades have in the DB? - Requser - account - security
	 */
	...
	Trade trade = null;
	User Requser = new User("tester", "pass", "firstname", "lastname", "123 Easy St", "Bobbitown", "TX", 75020,
			123456789, new Date(System.currentTimeMillis()), 1234567890, 0);
	User Recuser = new User("testing", "pass", "firstname", "lastname", "123 Easy St", "Bobbitown", "TX", 75020,
			123456789, new Date(System.currentTimeMillis()), 1234567890, 0);
	Account Reqacct = new Account(0, "Brokerage", "myBrokerage", 0.0, Requser);
	Account Recacct = new Account(0, "Brokerage1", "myBrokerage1", 0.0, Requser);
	AssetPricing ap = new AssetPricing("TEST", "Google", 1103.00);
